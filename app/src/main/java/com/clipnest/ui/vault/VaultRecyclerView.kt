    ...
    private class VaultRowView(context: Context) : LinearLayout(context) {
        ...
        init {
            ...
            checkbox = CheckBox(context).apply {
                ...
                minWidth = dp(48)
                minHeight = dp(48)
                contentDescription = context.getString(com.clipnest.R.string.select_card)
            }
            ...
            sensitiveLabel = TextView(context).apply {
                ...
                text = context.getString(com.clipnest.R.string.sensitive)
                textSize = 11f
            ...
            revealButton = ImageButton(context).apply {
                ...
                contentDescription = context.getString(com.clipnest.R.string.reveal_sensitive)
                background = null
            }
            ...
            pinnedLabel = TextView(context).apply {
                ...
                text = context.getString(com.clipnest.R.string.pinned)
                textSize = 11f
                setTypeface(Typeface.DEFAULT, Typeface.BOLD)
            }
            ...
            copyButton = ImageButton(context).apply {
                ...
                setImageResource(com.clipnest.R.drawable.ic_copy)
                contentDescription = context.getString(com.clipnest.R.string.copy_item)
                background = null
            }
            ...
            dragHandle = DragHandleView(context).apply {
                layoutParams = LayoutParams(dp(48), dp(48))
                contentDescription = context.getString(com.clipnest.R.string.drag_handle)
                isClickable = true
                isFocusable = false
            }
