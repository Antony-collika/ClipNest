    ...
    LazyColumn(
            ...
            OutlinedCard(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(
                        text = stringResource(com.clipnest.R.string.theme_preset),
                        style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Medium)
                    )
                    Text(
                        text = stringResource(com.clipnest.R.string.theme_preset_description),
                    ...
                    Text(
                        text = stringResource(com.clipnest.R.string.editor_text_size),
                        style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Medium)
                    )
                    Text(
                        text = stringResource(com.clipnest.R.string.editor_text_size_description),
                        style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant),
                        modifier = Modifier.padding(top = 4.dp)
                    )
                    Row(
                    ...
                    Text(
                        text = stringResource(com.clipnest.R.string.viewer_text_size),
                        style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Medium)
                    )
                    Text(
                        text = stringResource(com.clipnest.R.string.viewer_text_size_description),
                        style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant),
                        modifier = Modifier.padding(top = 4.dp)
                    )
                    Row(
                ...
                Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp)) {
                    ...
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text(
                                text = stringResource(com.clipnest.R.string.show_pinned_first),
                                style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Medium)
                            )
                            Text(
                                text = stringResource(com.clipnest.R.string.pinned_first_description),
                                style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant)
                            )
                        }
                        Switch(
            ...
            OutlinedCard(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(
                        text = stringResource(com.clipnest.R.string.default_save_folder),
                        style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Medium)
                    )
                    Text(
                        text = userSettings.defaultSaveFolderUri?.let { folderLabel(context, it) } ?: stringResource(com.clipnest.R.string.save_folder_not_set),
                        style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant),
                        modifier = Modifier.padding(top = 4.dp)
                    )
                    Row(
                        ...
                        if (userSettings.defaultSaveFolderUri != null) {
                            TextButton(onClick = viewModel::clearDefaultSaveFolder) {
                                Text(stringResource(com.clipnest.R.string.clear))
                            }
                        }
                    }
                }
            ...
            OutlinedCard(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Text(
                        text = stringResource(com.clipnest.R.string.backup_restore_description),
                        style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant)
                    )
                    Row(
                        modifier = Modifier
                        ...
                        TextButton(
                            ...
                            Text(stringResource(com.clipnest.R.string.backup_vault))
                        }
                        TextButton(
                            onClick = onRequestRestore,
                            modifier = Modifier.testTag("settings_restore_button")
                        ) {
                            Text(stringResource(com.clipnest.R.string.restore_vault))
                        }
                    }
                }
            }
            ...
            OutlinedCard(
                ...
                Column(modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp)) {
                    Row(
                        ...
                        Column(modifier = Modifier.weight(1f)) {
                            Text(
                                text = stringResource(com.clipnest.R.string.capture_notification),
                                style = MaterialTheme.typography.bodyLarge.copy(fontWeight = FontWeight.Medium)
                            )
                            Text(
                                text = stringResource(com.clipnest.R.string.capture_notification_description),
                                style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant)
                            )
                        }
                        Switch(
                    ...
                    Row(
                        ...
                        Column {
                            Text(
                                text = stringResource(com.clipnest.R.string.quick_settings_tile),
                                style = MaterialTheme.typography.bodyMedium.copy(fontWeight = FontWeight.SemiBold)
                            )
                            Text(
                                text = stringResource(com.clipnest.R.string.quick_settings_description),
                                style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant)
                            )
                        }
                    }
                        ...
                        exportedFiles.forEachIndexed { index, file ->
                            ...
                            Row(
                                ...
                                Column(modifier = Modifier.weight(1f)) {
                                    ...
                                    Text(
                                        text = stringResource(
                                            com.clipnest.R.string.file_details,
                                            dateStr,
                                            file.length()
                                        ),
                                        style = MaterialTheme.typography.bodySmall.copy(color = MaterialTheme.colorScheme.onSurfaceVariant)
                                ...
                                IconButton(onClick = {
                                    ...
                                    Icon(Icons.Default.Share, contentDescription = stringResource(com.clipnest.R.string.share_file), tint = MaterialTheme.colorScheme.primary)
                                }
                            }
                        }
                    }
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    Row(verticalAlignment = Alignment.CenterVertically) {
                        ...
                        Text(
                            text = stringResource(com.clipnest.R.string.private_by_design),
                    ...
                    Text(
                        text = stringResource(com.clipnest.R.string.private_notice),
    ...
    try {
        ...
        context.startActivity(
            Intent.createChooser(
                sendIntent,
                context.getString(com.clipnest.R.string.share_named_file, file.name)
            )
        )
    } catch (_: Exception) {
