...
import com.clipnest.MainActivity
...
class ShareDialogActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (com.clipnest.resolveIncomingDocumentUris(intent).isNotEmpty()) {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    Toast.makeText(
                        applicationContext,
                        if (count > 1) getString(com.clipnest.R.string.saved_to_vault_count, count) else getString(com.clipnest.R.string.saved_to_vault),
                        Toast.LENGTH_SHORT
                    ).show()
                    finishActivity()
                }
